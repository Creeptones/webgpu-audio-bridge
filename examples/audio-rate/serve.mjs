...
//
// Mirror of examples/minimal/serve.mjs; serves examples/audio-rate/ on port
// 5175 (one above fast-lane's 5174 so all three demos can run side-by-side).
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge audio-rate demo`);
