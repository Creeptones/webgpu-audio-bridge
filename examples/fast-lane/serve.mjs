...
//
// Mirror of examples/minimal/serve.mjs; serves examples/fast-lane/ on port 5174
// (one above minimal's 5173 so both demos can run side-by-side).
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge fast-lane demo`);
