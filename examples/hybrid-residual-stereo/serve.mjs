...
// copy-paste of the same server, retargeted at the stereo hybrid-residual
// demo directory. The headers stay identical because the SAB requirements
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge stereo hybrid-residual demo`);
