...
//
// Mirror of examples/audio-rate/serve.mjs; serves examples/hermite-orders/ on
// port 5182 (one above the highest existing demo port so all can run together).
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge Hermite-order A/B demo`);
