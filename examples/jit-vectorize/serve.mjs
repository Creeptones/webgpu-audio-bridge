...
//
// Mirror of examples/god-node-hotswap/serve.mjs; serves examples/jit-vectorize/
// on port 5185 (5173–5184 are taken; 5184 = dev:mpmc-fan-in). The cross-origin
...
// (A production app uses a bundler or an app-level import map instead.)
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge — The Autonomous JIT demo`);
