...
// copy-paste of the same server, retargeted at the four-tier hybrid demo
// directory. The headers stay identical because the SAB requirements don't
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge four-tier hybrid demo`);
