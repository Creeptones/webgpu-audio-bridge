...
//
// Mirror of examples/hermite-orders/serve.mjs; serves examples/god-node-hotswap/
// on port 5183 (one above hermite-orders' 5182 so all demos can run together).
...
server.listen(PORT, () => {
  console.log(`webgpu-audio-bridge God-Node hot-swap demo`);
