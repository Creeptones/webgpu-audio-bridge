...
import { type IrKernel, type IrNode, type LaneWidth, LANES } from "./ir.js";
...
export function vectorize(ir: IrKernel, exportName = "kernel"): VectorizeResult {
  ...
  // Emittability: every store contiguous; every load contiguous (v1).
  ...
  return { ok: true, plan: { width: ir.width, laneWidth: W, arrays, scalars, exportName } };
}
